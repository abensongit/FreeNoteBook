...
@implementation JSLProgressLoopView
...
{
    JSLProgressLoopView *progressView = [[JSLProgressLoopView alloc] initWithFrame:CGRectMake(0, 0, defaultWidth, defaultWidth)];
