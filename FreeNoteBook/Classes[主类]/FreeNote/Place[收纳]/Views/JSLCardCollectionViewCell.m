...
@interface JSLCardCollectionViewCell()
...
@implementation JSLCardCollectionViewCell
...
- (UIImageView *)arrowImageView
{
    if (!_arrowImageView) {
        ...
        _arrowImageView.image = [UIImage imageNamed:ICON_PLACE_IMAGE_ERROR];
...
- (UIButton *)deleteButton
{
    if (!_deleteButton) {
        ...
        [_deleteButton setImage:[UIImage imageNamed:ICON_PLACE_PUBLISH_CANCLE]
