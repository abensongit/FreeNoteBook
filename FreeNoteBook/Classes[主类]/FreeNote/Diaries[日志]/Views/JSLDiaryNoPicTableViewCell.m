...
#import "JSLVerticallyAlignedLabel.h"

@interface JSLDiaryNoPicTableViewCell()

@property (nonatomic, strong) JSLVerticallyAlignedLabel *contentLabel;
@property (nonatomic, strong) UILabel *dateLabel;
@property (nonatomic, strong) UILabel *yearLabel;

@end

@implementation JSLDiaryNoPicTableViewCell
...
- (JSLVerticallyAlignedLabel *)contentLabel
{
    if (!_contentLabel) {
        _contentLabel = [[JSLVerticallyAlignedLabel alloc] init];
...
- (void)updateCellWithDiaryInfo:(JSLDiaryInfo *)diaryInfo
{
