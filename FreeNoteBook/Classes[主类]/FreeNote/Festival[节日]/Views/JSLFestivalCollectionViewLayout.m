...
@interface JSLFestivalCollectionViewLayout ()
...
@implementation JSLFestivalCollectionViewLayout
...
- (void)prepareLayout
{
    ...
    for (NSInteger section = 0; section < numSections; section++) {
        ...
        for (NSInteger item = 0; item < numItems; item++) {
            ...
            CGFloat height = [((id<JSLFestivalCollectionViewLayoutDelegate>)self.collectionView.delegate)
